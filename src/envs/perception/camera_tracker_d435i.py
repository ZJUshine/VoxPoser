...
class CameraTracker:
    def __init__(self):
        ...
        self.owlvit_processor = Owlv2Processor.from_pretrained("/mnt/data/google/owlv2-base-patch16-ensemble")
        self.owlvit_model = Owlv2ForObjectDetection.from_pretrained("/mnt/data/google/owlv2-base-patch16-ensemble").to(self.device)

        # Initialize SAM model
        self.sam_model = SAM("/mnt/data/models/sam2.1_b.pt")
        ...
        weights = torch.load('/mnt/data/models/XMem.pth', map_location=self.device)
